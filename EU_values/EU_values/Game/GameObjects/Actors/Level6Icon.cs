...
public class Level6Icon : Actor, IStorable
{
    private static string _framesetPath = "..\\..\\..\\Resources\\Images\\Levels\\Level_6\\Icons\\";
    public string Name { get; private set; }
    public string Description { get; private set; }
    public string ID;

    public Level6Icon(string name, float x, float y, string imageName)
        : base(name, x, y,
