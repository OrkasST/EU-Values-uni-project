...
public class Mask : Actor, IStorable
{
    private readonly static string _framesetPath = "..\\..\\..\\Resources\\Images\\Levels\\Level_1\\Masks\\";
    ...
    public Mask(string name, string description, float x, float y, int timeToFirstJump) : base(name, x, y,
        frameset: new(name, x, y, width: 64, height: 64, Image.FromFile($"{_framesetPath}Mask_{name}.png"), xFramesNumber: 1, yFramesNumber: 1, isCameraAffected: true),
